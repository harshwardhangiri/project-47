...
function draw() {
  ...
  if(gameState === "PLAY"){
   ...
   textSize(20);
   fill("yellow");
   text ("Score: "+score,displayWidth+50,displayHeight+50);
...
if(blastGroup.isTouching(monster4Group)){
   ...
   if (gameState === "END"){
	 ...
	 textSize(40);
	 fill ("yellow")
	 text("	You loose your ship is captured",displayWidth/2-300,displayHeight/2-100);
   }
   
   
   if(gameState==="WIN"){
	   var lame = createSprite(displayWidth/2,displayHeight/2,10,10);
	   lame.addImage(won);
	   lame.scale=5;
	   monster1Group.destroyEach();
	   monster2Group.destroyEach();
	   ...
	   textSize(30);
	   fill ("yellow")
	   text("Press space to restart",displayWidth/2-300,displayHeight/4);
